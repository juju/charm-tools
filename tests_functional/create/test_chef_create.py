...
class ChefCreateTest(TestCase):
    ...
    def _expected_files(self):
        static_files = [
            ...
            'hooks/cookbooks/testcharm/metadata.rb',
            'hooks/cookbooks/testcharm/recipes/config-changed.rb',
            'hooks/cookbooks/testcharm/recipes/install.rb',
            'hooks/cookbooks/testcharm/recipes/start.rb',
            'hooks/cookbooks/testcharm/recipes/stop.rb',
            'hooks/cookbooks/testcharm/recipes/upgrade-charm.rb',
            'hooks/cookbooks/juju-helpers/definitions/juju_port.rb',
            'hooks/cookbooks/juju-helpers/definitions/relation_set.rb',
            'hooks/cookbooks/juju-helpers/libraries/juju.rb',
            'hooks/cookbooks/juju-helpers/libraries/juju/juju_helpers_dev.rb',
            'hooks/cookbooks/juju-helpers/libraries/juju/juju_helpers.rb',
            'hooks/cookbooks/juju-helpers/metadata.rb',
            'hooks/cookbooks/relation-name-relation/metadata.rb',
            'hooks/cookbooks/relation-name-relation/recipes/broken.rb',
