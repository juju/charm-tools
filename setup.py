...
setup(
    ...
    install_requires=[
        ...
        'libcharmstore',
        'blessings<=1.6;python_version < "3.10"',
        'ruamel.yaml<0.16.0;python_version < "3.10"',
        'pathspec<=0.3.4;python_version < "3.10"',
        'blessings;python_version >= "3.10"',
        'ruamel.yaml;python_version >= "3.10"',
        'pathspec;python_version >= "3.10"',
        'otherstuf<=1.1.0',
        'path.py>=10.5',
        'pip>=1.5.4',
        'jujubundlelib',
